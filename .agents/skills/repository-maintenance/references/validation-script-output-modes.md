...
**Applies to**: When adding or reviewing `--quiet` or `-q` behavior in validation, hook, or CI shell scripts.
...
- [Shell Scripting Patterns](../../shell-scripting/references/shell-scripting-patterns.md) — Strict mode, quoting, traps, argument parsing
- [GitHub Actions Bash Scripts](../../ci-troubleshooting/references/github-actions-bash-scripts.md) — CI-focused Bash patterns and subshell pitfalls
- [Testing Error Message Quality](../../testing-rust/references/testing-error-message-quality.md) — Diagnostic output expectations
