...
**Applies to**: Before committing any change — ensures all linters, formatters, and validation gates pass.
...
- Choosing test strategies (see [Testing Core Patterns](../../testing-rust/references/testing-core-patterns.md))
- Configuring clippy rules (see [Clippy And Linting](../../rust-development/references/clippy-and-linting.md))
...
4. **For user-visible changes**: run changelog flow
   [Classify User Visible Changes](../../documentation-quality/references/classify-user-visible-changes.md) ->
   [Update Changelog Keep A Changelog](../../documentation-quality/references/update-changelog-keep-a-changelog.md) ->
   [Review Changelog Entries](../../documentation-quality/references/review-changelog-entries.md).
...
- `check-ci-config.sh`: Catches outdated action versions incompatible with current `Cargo.lock`
  ...
  format (see [Supply Chain Audit Policy](../../dependency-supply-chain/references/supply-chain-audit-policy.md))

- `check-msrv-consistency.sh`: Validates all configuration files use the same Rust version as

  `Cargo.toml` (see [MSRV Management](../../toolchain-management/references/msrv-management.md))
...
- `check-doc-consistency.sh`: Enforces Cargo version reference sync, Keep a Changelog
  ...
  [Doc Accuracy Guarantees](../../documentation-quality/references/doc-accuracy-guarantees.md))
...
- [ ] New code has exhaustive tests (see [Testing Core Patterns](../../testing-rust/references/testing-core-patterns.md))
- [ ] Documentation updated (see [Documentation Standards](../../documentation-quality/references/documentation-standards.md))
- [ ] CHANGELOG decision documented via [Classify User Visible Changes](../../documentation-quality/references/classify-user-visible-changes.md)
- [ ] CHANGELOG updated for user-facing changes via [Update Changelog Keep A Changelog](../../documentation-quality/references/update-changelog-keep-a-changelog.md)
- [ ] CHANGELOG reviewed via [Review Changelog Entries](../../documentation-quality/references/review-changelog-entries.md)
- [ ] Breaking changes documented
- [ ] MSRV update documented (if applicable, see [MSRV Management](../../toolchain-management/references/msrv-management.md))

---

## Security Checklist (Pre-Merge)

- [ ] No `.unwrap()` on user input (see [Defensive Programming](../../rust-development/references/defensive-programming.md))
...
Use [Web Service Security Auth](../../web-service-security/references/web-service-security-auth.md)
and [Code Review Checklist](../../agent-quality/references/code-review-checklist.md) skills for comprehensive audit.
