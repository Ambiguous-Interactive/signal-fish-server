...
**Applies to**: When editing protocol docs, integration tests, or bootstrap/CI shell scripts —
...
(no hand-kept list) over eyeballing. See [Documentation Accuracy Guarantees](../../documentation-quality/references/doc-accuracy-guarantees.md).
...
- [Documentation Accuracy Guarantees](../../documentation-quality/references/doc-accuracy-guarantees.md)
- [Shell Scripting Patterns](../../shell-scripting/references/shell-scripting-patterns.md)
- [Testing Core Patterns](../../testing-rust/references/testing-core-patterns.md)
