...
**Applies to**: When implementing WebSocket session creation, token-based auth, JWT validation,
...
- WebSocket framing or heartbeat (see [WebSocket Protocol Patterns](../../websocket-protocol/references/websocket-protocol-patterns.md))
...
- [WebSocket Protocol Patterns](../../websocket-protocol/references/websocket-protocol-patterns.md) — WebSocket lifecycle, message framing, heartbeat
