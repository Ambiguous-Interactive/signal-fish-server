...
**Applies to**: When implementing rate limiting middleware, connection caps, WebSocket throttling, or frame size limits.
...
- Non-security performance work (see [Rust Performance Optimization](../../rust-development/references/rust-performance-optimization.md))
...
- [WebSocket Protocol Patterns](../../websocket-protocol/references/websocket-protocol-patterns.md) — WebSocket lifecycle, message design, heartbeat
