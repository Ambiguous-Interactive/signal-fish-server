# Dependency Management — Versioning and MSRV

**Applies to**: When pinning dependency versions, checking MSRV compatibility, or choosing between crate alternatives.
...
- Follow the MSRV update checklist in [MSRV Management](../../toolchain-management/references/msrv-management.md)
...
See [MSRV Management](../../toolchain-management/references/msrv-management.md) for comprehensive guidance.
...
- [MSRV Management](../../toolchain-management/references/msrv-management.md) — MSRV updates and consistency
- [Supply Chain Audit Policy](./supply-chain-audit-policy.md) — Dependency security audits and SBOMs
- [Rust Performance Optimization](../../rust-development/references/rust-performance-optimization.md) — Alternative crate recommendations
- [Testing Core Patterns](../../testing-rust/references/testing-core-patterns.md) — Testing with optional dependencies
