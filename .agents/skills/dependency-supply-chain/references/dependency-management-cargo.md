...
**Applies to**: When adding, updating, removing, or auditing Rust crate dependencies.
...
- Designing APIs for your own crate (see [API Design Guidelines](../../rust-development/references/api-design-guidelines.md))
...
See [Container Docker](../../deployment-operations/references/container-docker.md) for details.
...
- [Clippy And Linting](../../rust-development/references/clippy-and-linting.md) — CI integration for dependency checks
