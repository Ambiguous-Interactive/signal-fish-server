...
**Applies to**: When auditing dependencies for vulnerabilities, configuring cargo-deny policies,
...
- Application-level security (see [Web Service Security Auth](../../web-service-security/references/web-service-security-auth.md))
...
Docker multi-stage builds must also use `--locked`. See [Container Docker](../../deployment-operations/references/container-docker.md)
...
- [Web Service Security Hardening](../../web-service-security/references/web-service-security-hardening.md) —
  Application-level security, auth, input validation, TLS
- [Container Docker](../../deployment-operations/references/container-docker.md) — Dockerfile hardening, image scanning, CI/CD pipelines
