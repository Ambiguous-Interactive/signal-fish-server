...
**Applies to**: When writing or reviewing assertion failure text for toolchain/MSRV consistency tests.
...
- [MSRV Management](../../toolchain-management/references/msrv-management.md) — MSRV policy and consistency rules
