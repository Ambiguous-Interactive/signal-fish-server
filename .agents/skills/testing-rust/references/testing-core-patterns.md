...
**Applies to**: When writing tests, choosing test patterns, or structuring test code.
...
- Production error handling (see [Error Handling Guide](../../rust-development/references/error-handling-guide.md))
- Benchmark-specific setup (see [Rust Performance Optimization](../../rust-development/references/rust-performance-optimization.md))
...
`"  - Cargo.lock"`) not bare substrings. See [CI CD Troubleshooting Scripts](../../ci-troubleshooting/references/ci-cd-troubleshooting-scripts.md).
...
- [Error Handling Guide](../../rust-development/references/error-handling-guide.md) — Testing error conditions
- [Defensive Programming](../../rust-development/references/defensive-programming.md) — Edge cases to test
