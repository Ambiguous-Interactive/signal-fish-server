...
See [Core Testing Patterns](testing-core-patterns.md) and
[Testing Tools and Frameworks](testing-tools-and-frameworks.md) for full methodology.
...
[Mutation Testing Performance](mutation-testing-performance.md) for the
