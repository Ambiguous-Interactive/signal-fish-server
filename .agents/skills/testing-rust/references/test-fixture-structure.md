...
**Applies to**: When creating or organizing test fixtures for CI/CD workflow or configuration testing.
...
- Performance benchmarks (see [Rust Performance Optimization](../../rust-development/references/rust-performance-optimization.md))
