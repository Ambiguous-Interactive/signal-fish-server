...
**Applies to**: When choosing or configuring testing tools, frameworks, or coverage measurement.
...
- [Rust Performance Optimization](../../rust-development/references/rust-performance-optimization.md) — Benchmark setup with criterion
- [Async Rust Best Practices](../../rust-development/references/async-rust-best-practices.md) — Async test patterns
