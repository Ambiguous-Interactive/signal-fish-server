...
**Applies to**: When designing, reviewing, or refactoring code to ensure adherence
...
- [Code Review Checklist](../../agent-quality/references/code-review-checklist.md) — Review process incorporating SOLID checks
...
- [Agentic Workflow Patterns](../../agent-quality/references/agentic-workflow-patterns.md) — AI agent workflow patterns for code review
