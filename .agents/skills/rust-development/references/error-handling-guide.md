...
**Applies to**: When designing error types, converting `.unwrap()` to proper handling, or adding error context.
...
- Logging errors specifically (see [Observability And Logging](../../deployment-operations/references/observability-and-logging.md))
...
- [Observability And Logging](../../deployment-operations/references/observability-and-logging.md) — Structured error logging
