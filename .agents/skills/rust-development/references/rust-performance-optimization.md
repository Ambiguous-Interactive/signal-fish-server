...
**Applies to**: When optimizing hot paths, reducing allocations, or profiling performance-critical code.
...
See [Observability And Logging](../../deployment-operations/references/observability-and-logging.md).
...
- [Dependency Management Cargo](../../dependency-supply-chain/references/dependency-management-cargo.md) — Alternative crate recommendations
- [Observability And Logging](../../deployment-operations/references/observability-and-logging.md) — Metrics for performance monitoring
