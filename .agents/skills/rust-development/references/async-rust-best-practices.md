...
**Applies to**: When writing or modifying any async code, tokio tasks, channels, or concurrent data access.
...
- [Observability And Logging](../../deployment-operations/references/observability-and-logging.md) — Tracing spans for async functions
- [WebSocket Protocol Patterns](../../websocket-protocol/references/websocket-protocol-patterns.md) — Async WebSocket handling
