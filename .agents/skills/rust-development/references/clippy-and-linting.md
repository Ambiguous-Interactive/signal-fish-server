...
**Applies to**: When configuring lints, resolving clippy warnings, or setting up CI lint enforcement.
...
- [Testing Core Patterns](../../testing-rust/references/testing-core-patterns.md) — CI pipeline integration
