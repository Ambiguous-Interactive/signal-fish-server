...
**Applies to**: When designing or modifying any public API surface, protocol types, HTTP endpoints, or SDK interfaces.
...
See [WebSocket Protocol Patterns](../../websocket-protocol/references/websocket-protocol-patterns.md) for full message design.
...
- [WebSocket Protocol Patterns](../../websocket-protocol/references/websocket-protocol-patterns.md) — WebSocket-specific API patterns
