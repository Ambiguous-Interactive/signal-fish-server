...
**Applies to**: Before marking any task as complete, before presenting changes to user,
...
⛔ **CRITICAL**: You NEVER commit changes - see [Git Safety Forbidden Operations](../../version-control-workflow/references/git-safety-forbidden-operations.md)
...
- After `.agents/skills` edits, run `scripts/check-agent-skill-files.sh` before handoff
...
- [ ] **Config drift guards assert the live view**: presence checks
  ...
  [CI Config Live View Tests](../../ci-troubleshooting/references/ci-config-live-view-tests.md)
...
See [Git Safety Forbidden Operations](../../version-control-workflow/references/git-safety-forbidden-operations.md) for complete details.
...
⛔ **YOU NEVER**: Stage, commit, configure git, or push. See [Git Safety Forbidden Operations](../../version-control-workflow/references/git-safety-forbidden-operations.md).
...
- [Testing Core Patterns](../../testing-rust/references/testing-core-patterns.md) — How to write effective tests
