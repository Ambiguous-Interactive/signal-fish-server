...
**Applies to**: When planning or executing multi-step AI agent workflows, dispatching subagents,
...
See [Git Safety Forbidden Operations](../../version-control-workflow/references/git-safety-forbidden-operations.md).
...
- [Git Safety Forbidden Operations](../../version-control-workflow/references/git-safety-forbidden-operations.md) — **CRITICAL** - Never commit or configure git
- [Code Review Checklist](./code-review-checklist.md) — Detailed review criteria
- [Rust Refactoring Guide](../../rust-development/references/rust-refactoring-guide.md) — Safe refactoring workflow
- [Testing Core Patterns](../../testing-rust/references/testing-core-patterns.md) — Test writing methodology
