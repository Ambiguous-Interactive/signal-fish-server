...
**Applies to**: When you need to perform git read operations or provide commit instructions to the user.
...
- [Agent Self Review Checklist](../../agent-quality/references/agent-self-review-checklist.md) — Pre-commit verification (user commits after)
- [GitHub Actions Workflow Config](../../ci-troubleshooting/references/github-actions-workflow-config.md) — CI/CD patterns
