...
**Applies to**: When setting up git hooks in a repository, ensuring hooks are tracked with correct
...
- README badge and hook speed policy

Run Agent Skill structure, size, and catalog checks in local or hosted CI to keep hooks sub-second.
...
- [Shell Scripting Patterns](../../shell-scripting/references/shell-scripting-patterns.md) — Shell scripting best practices
