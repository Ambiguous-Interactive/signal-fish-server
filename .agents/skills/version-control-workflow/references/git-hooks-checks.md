# Git Hooks Check Implementations

**Applies to**: When writing specific check implementations for pre-commit hooks, optimizing hook
...
- Minimal Git wrapper reference:
  [pre-commit-fast.sh](pre-commit-fast.sh)
- Performance patterns and anti-patterns:
  [performance-patterns.sh](performance-patterns.sh)
- CI validation test patterns:
  [ci-hook-validation-tests.rs](ci-hook-validation-tests.rs)
- Debugging snippets:
  [debugging-snippets.sh](debugging-snippets.sh)
...
- [GitHub Actions Workflow Config](../../ci-troubleshooting/references/github-actions-workflow-config.md) — CI/CD workflow patterns
- [CI CD Troubleshooting Scripts](../../ci-troubleshooting/references/ci-cd-troubleshooting-scripts.md) — Debugging CI failures
- [Mandatory Workflow](../../repository-maintenance/references/mandatory-workflow.md) — Required validation steps
