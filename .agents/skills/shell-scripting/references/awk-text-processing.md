...
**Applies to**: When writing AWK scripts for CI/CD workflows, processing multi-line content,
...
- [GitHub Actions Awk](../../ci-troubleshooting/references/github-actions-awk.md) — AWK examples in workflow YAML
