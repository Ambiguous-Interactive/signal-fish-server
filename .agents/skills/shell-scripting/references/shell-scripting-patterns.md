...
**Applies to**: When writing shell scripts for CI/CD pipelines, debugging subshell variable scope
...
Quiet/silent flag behavior lives in [Validation Script Output Modes](../../repository-maintenance/references/validation-script-output-modes.md);
...
- [GitHub Actions Bash Scripts](../../ci-troubleshooting/references/github-actions-bash-scripts.md) — Shellcheck in CI workflows
- [CI CD Troubleshooting Scripts](../../ci-troubleshooting/references/ci-cd-troubleshooting-scripts.md) — Debugging CI script failures
- [Validation Script Output Modes](../../repository-maintenance/references/validation-script-output-modes.md) — `--quiet` behavior and failure-summary rules
- [Repo Source Hygiene Guards](../../repository-maintenance/references/repo-source-hygiene-guards.md) — `return`-not-`exit` and `python3 -m pip` guards
