...
**Applies to**: When editing public docs/examples, protocol docs, or behavioral guarantees.
...
- Wire strings (`reason`, `error_code`) in examples must be copied verbatim from their
  ...
  it — see [Repo Source Hygiene Guards](../../repository-maintenance/references/repo-source-hygiene-guards.md). The reconnection
...
- [ ] `AGENTS.md` protocol quick reference matches implementation
