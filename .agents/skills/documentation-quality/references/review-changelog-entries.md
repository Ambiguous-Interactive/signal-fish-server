...
**Applies to**: After editing `CHANGELOG.md` and before finalizing work.
...
- [Agent Self Review Checklist](../../agent-quality/references/agent-self-review-checklist.md) — Full task quality checks
