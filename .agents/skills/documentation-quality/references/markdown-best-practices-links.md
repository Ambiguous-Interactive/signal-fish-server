...
**Applies to**: When fixing broken links, setting up link validation in CI, or dealing with case-sensitive
...
```markdown
❌ REDUNDANT
See [testing-core-patterns](../../testing-rust/references/testing-core-patterns.md).

✅ HUMAN-READABLE
See [Core Testing Patterns](../../testing-rust/references/testing-core-patterns.md).
```
...
See [testing guide](../../testing-rust/references/testing-core-patterns.md)
...
- [Markdown Best Practices Linting](./markdown-best-practices-linting.md) — Linting rules and CI/CD integration
- [Markdown Best Practices Formatting](./markdown-best-practices-formatting.md) — Proper nouns and spell checking
- [CI CD Troubleshooting Categories](../../ci-troubleshooting/references/ci-cd-troubleshooting-categories.md) — Debugging link check failures
