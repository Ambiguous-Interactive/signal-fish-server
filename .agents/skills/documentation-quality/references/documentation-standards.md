...
**Applies to**: When adding features, fixing bugs, or making any user-facing change that requires documentation updates.
...
- Writing test documentation (see [Testing Core Patterns](../../testing-rust/references/testing-core-patterns.md))
- Formatting/linting docs (see [Mandatory Workflow](../../repository-maintenance/references/mandatory-workflow.md))
...
- Move long/reusable examples to `.agents/skills/*/references/` and reference them from markdown.
