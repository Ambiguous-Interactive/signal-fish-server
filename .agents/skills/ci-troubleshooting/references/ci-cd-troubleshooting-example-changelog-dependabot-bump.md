...
**Applies to**: When changelog policy blocks dependency-only changes after bot PR merge workflows.
...
- [Version Sync And Changelog Gates](../../documentation-quality/references/version-sync-and-changelog-gates.md) — Changelog gating policy
- [Testing Core Patterns](../../testing-rust/references/testing-core-patterns.md) — Data-driven testing techniques
