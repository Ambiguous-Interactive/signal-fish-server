...
**Applies to**: When debugging Dockerfile `COPY` path errors, invalid or moving
...
- [Supply Chain Audit Policy](../../dependency-supply-chain/references/supply-chain-audit-policy.md) — Security audits and scanning
