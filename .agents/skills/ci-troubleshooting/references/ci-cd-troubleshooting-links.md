...
**Applies to**: When debugging lychee link checker failures, `.lychee.toml` regex vs glob
...
- [Supply Chain Audit Policy](../../dependency-supply-chain/references/supply-chain-audit-policy.md) — Security audits and vulnerability scanning
