...
**Applies to**: When configuring caching in workflows, pinning action versions,
...
- Container build and deployment patterns (see [Container Docker](../../deployment-operations/references/container-docker.md))
