...
Canonical sample: [v2-client-messages.jsonl](v2-client-messages.jsonl)

### v2 Server Messages

Canonical sample: [v2-server-messages.jsonl](v2-server-messages.jsonl)

### v3 Client Messages (additive over v2)

Canonical sample: [v3-client-messages.jsonl](v3-client-messages.jsonl)

### v3 Server Messages (additive over v2)

Canonical sample: [v3-server-messages.jsonl](v3-server-messages.jsonl)
...
2. Follow [Mandatory Workflow and Checklists](../../repository-maintenance/references/mandatory-workflow.md) for validation.
