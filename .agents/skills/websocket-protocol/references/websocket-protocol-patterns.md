...
**Applies to**: When working with WebSocket handlers, message protocol design, or broadcast patterns.
...
- General HTTP API endpoints (see [API Design Guidelines](../../rust-development/references/api-design-guidelines.md))
- Generic async patterns (see [Async Rust Best Practices](../../rust-development/references/async-rust-best-practices.md))
...
- [Async Rust Best Practices](../../rust-development/references/async-rust-best-practices.md) — Async patterns for connection handling
- [API Design Guidelines](../../rust-development/references/api-design-guidelines.md) — Message type design
- [Error Handling Guide](../../rust-development/references/error-handling-guide.md) — WebSocket error codes and handling
- [Observability And Logging](../../deployment-operations/references/observability-and-logging.md) — Connection lifecycle tracing
