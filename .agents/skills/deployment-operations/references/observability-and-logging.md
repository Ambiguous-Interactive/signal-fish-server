...
**Applies to**: When adding logging, metrics, tracing spans, or OpenTelemetry instrumentation.
...
- Error type design (see [Error Handling Guide](../../rust-development/references/error-handling-guide.md))
- Performance profiling with criterion (see [Rust Performance Optimization](../../rust-development/references/rust-performance-optimization.md))
...
- [Error Handling Guide](../../rust-development/references/error-handling-guide.md) — Structured error logging patterns
- [Async Rust Best Practices](../../rust-development/references/async-rust-best-practices.md) — Tracing spans for async functions
- [Defensive Programming](../../rust-development/references/defensive-programming.md) — Logging at system boundaries
