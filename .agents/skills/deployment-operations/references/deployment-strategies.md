...
**Applies to**: When configuring Kubernetes deployments, health checks, graceful shutdown for WebSocket
...
- [Container Security](../../web-service-security/references/container-security.md) — Secrets management, security contexts
