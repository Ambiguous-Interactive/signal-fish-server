...
**Applies to**: When implementing circuit breakers, service level degradation, feature flags, or
...
- [DDoS Rate Limiting Connections](../../web-service-security/references/ddos-rate-limiting-connections.md) — Rate limiting, connection caps, load shedding
