...
(* timeout-inversion hazard the config cross-field check prevents):         *)
(*                                                                         *)
...
(*                                                                         *)
(* TIME MODEL (house rule: discrete integer `now` + `Tick`,                 *)
...
(*                                                                         *)
(* THE DERIVED INEQUALITY. With the pre-park delay                           *)
