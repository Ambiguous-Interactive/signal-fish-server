---
name: github-actions-awk
description: >-
  Apply project guidance for AWK in CI/CD pipelines. Use when writing AWK scripts for CI
  pipelines, extracting code blocks from Markdown, or debugging AWK failures on Ubuntu runners.
---
...
- Non-AWK shell scripting issues (see [GitHub Actions Bash Scripts](../github-actions-bash-scripts/SKILL.md))
...
- [GitHub Actions Bash Scripts](../github-actions-bash-scripts/SKILL.md) — Shellcheck, variable quoting, subshells
