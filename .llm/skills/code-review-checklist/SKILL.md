...
description: >-
  Apply project guidance for code review checklist. Use when reviewing code changes, pull
  requests, or auditing code quality.
---
...
See [Solid Principles Enforcement](../solid-principles-enforcement/SKILL.md) for detailed guidance.
...
See [Agentic Workflow Patterns](../agentic-workflow-patterns/SKILL.md).
...
- [Solid Principles Enforcement](../solid-principles-enforcement/SKILL.md) — Detailed SOLID principle guidance
- [Rust Refactoring Guide](../rust-refactoring-guide/SKILL.md) — Safe refactoring workflows
- [Defensive Programming](../defensive-programming/SKILL.md) — Zero runtime panics
- [Error Handling Guide](../error-handling-guide/SKILL.md) — Proper error propagation
- [Agentic Workflow Patterns](../agentic-workflow-patterns/SKILL.md) — Subagent review workflows
