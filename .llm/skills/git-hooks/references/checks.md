...
- Initial hook setup and permissions (see [Git Hooks Installation](../SKILL.md))
...
- [Git Hooks Installation](../SKILL.md) — Setup, permissions, team onboarding
- [GitHub Actions Workflow Config](../../github-actions-workflow-config/SKILL.md) — CI/CD workflow patterns
- [CI CD Troubleshooting Scripts](../../ci-cd-troubleshooting/references/scripts-and-tests.md) — Debugging CI failures
- [Mandatory Workflow](../../mandatory-workflow/SKILL.md) — Required validation steps
