...
description: >-
  Pin and maintain stable, MSRV, and nightly Rust toolchains for local development and CI tools.
  Use when changing `rust-toolchain.toml`, nightly dates, toolchain update automation, or
  compiler compatibility jobs.
---

# Rust Toolchain Pinning and MSRV Testing

Read [Nightly Update Script Example](references/example-nightly-update-script.md) when implementing
or reviewing automation that advances a pinned nightly toolchain.

See also:

- [MSRV Management](../msrv-management/SKILL.md) — MSRV definition, config files, update checklist
- [Toolchain Nightly](references/nightly-toolchains.md) — Nightly Rust for CI-only analysis tools
...
**Correct:** Update all files using the checklist in [MSRV Management](../msrv-management/SKILL.md).
...
- [MSRV Management](../msrv-management/SKILL.md) — MSRV definition, config files, update checklist, CI
- [Toolchain Nightly](references/nightly-toolchains.md) — Nightly Rust for CI-only tools
- [GitHub Actions Workflow Config](../github-actions-workflow-config/SKILL.md) — CI/CD workflow patterns
