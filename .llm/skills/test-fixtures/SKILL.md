...
name: test-fixtures
description: >-
  Design and maintain deterministic test fixtures and CI configuration tests. Use when
  organizing fixtures, adding preventive configuration tests, naming fixture cases, or debugging
  fixture drift.
---

# Test Fixture Structure and Organization
...
- Application unit tests (see [Testing Core Patterns](../testing/SKILL.md))
- Writing the data-driven test patterns (see [Test Fixture CI Patterns](references/ci-patterns.md))
- Performance benchmarks (see [Rust Performance Optimization](../rust-performance-optimization/SKILL.md))
...
- [Test Fixture CI Patterns](references/ci-patterns.md) — Data-driven CI configuration test patterns
- [Testing Core Patterns](../testing/SKILL.md) — Core testing methodology and patterns
- [Testing Error Message Quality](../testing/references/error-message-quality.md) — Actionable test failure messages
