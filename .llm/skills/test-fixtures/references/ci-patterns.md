# CI Configuration Test Patterns
...
- Fixture organization and structure (see [Test Fixture Structure](../SKILL.md))
- Application unit tests (see [Testing Core Patterns](../../testing/SKILL.md))
- CI smoke tests (see [Testing CI Coverage](../../testing/references/ci-and-coverage.md))
...
- [Test Fixture Structure](../SKILL.md) — Fixture directory layout, naming, and documentation
- [Testing Core Patterns](../../testing/SKILL.md) — Core testing methodology and patterns
- [Testing Error Message Quality](../../testing/references/error-message-quality.md) — Actionable failure messages
...
- [Markdown Best Practices Formatting](../../markdown-best-practices/references/formatting-and-spelling.md) —
