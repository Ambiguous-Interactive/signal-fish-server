...
description: >-
  Secure HTTP and WebSocket services through validation, authentication, authorization, TLS,
  secrets, headers, safe Rust settings, and security telemetry. Use for security-sensitive
  endpoints, inputs, credentials, or operational hardening.
---
...
- Secrets management and TLS (see [Web Service Security Hardening](references/hardening-and-operations.md))
...
- [Web Service Security Hardening](references/hardening-and-operations.md) — Secrets, TLS, Rust safety, security logging
- [Defensive Programming](../defensive-programming/SKILL.md) — Input validation, panic prevention, safe arithmetic
- [Error Handling Guide](../error-handling-guide/SKILL.md) — Error types, generic messages, context propagation
