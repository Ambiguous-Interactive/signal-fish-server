# Web Service Security — Hardening and Operational Security
...
- Input validation and authentication patterns (see [Web Service Security Auth](../SKILL.md))
...
- [Web Service Security Auth](../SKILL.md) — Input validation, authentication, WebSocket security
- [Observability And Logging](../../observability-and-logging/SKILL.md) — Structured logging, tracing spans, log hygiene
- [Dependency Management Cargo](../../dependency-management/SKILL.md) — Cargo.lock, audit workflows
- [Supply Chain Audit Policy](../../supply-chain-security/SKILL.md) — Full supply chain audit pipeline
