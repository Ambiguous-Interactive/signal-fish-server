# Skill: Supply Chain Example - rustls-pemfile to rustls-pki-types Migration

<!--
  trigger: supply chain example rustls-pemfile migration, rustsec-2025-0134 example
  | Example incident: migrating off unmaintained rustls-pemfile
  | Infrastructure
-->

**Trigger**: When `cargo deny` reports unmaintained advisory RUSTSEC-2025-0134 for `rustls-pemfile`.
