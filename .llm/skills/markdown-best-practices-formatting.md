# Skill: Markdown Proper Nouns and Spell Checking

<!--
  trigger: markdown, proper nouns, capitalization, spell checking, typos, HashiCorp, GitHub, WebSocket
  | Correct capitalization and spell-check configuration for Markdown documentation
  | Documentation
-->

**Trigger**: When fixing capitalization of proper nouns, configuring the `typos` spell checker, or
