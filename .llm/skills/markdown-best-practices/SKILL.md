...
description: >-
  Author, lint, and validate Markdown, including fenced code, links, spelling, formatting, and
  CI integration. Use when editing Markdown, fixing markdownlint or link-check failures, or
  changing documentation validation.
---

# Markdown Linting and CI/CD Integration

Read [Code Block Validation](references/code-block-validation.md) when implementing or debugging
fence-aware validation rather than merely fixing a document's fenced blocks.

See also:

- [Markdown Best Practices Code Blocks](references/code-blocks.md) — Code block best practices
- [Markdown Best Practices Links](references/link-validation.md) — Link validation
- [Markdown Best Practices Formatting](references/formatting-and-spelling.md) — Proper nouns and spell checking
...
- [Markdown Best Practices Code Blocks](references/code-blocks.md) — Code block language identifiers
- [Markdown Best Practices Links](references/link-validation.md) — Link validation patterns
- [Markdown Best Practices Formatting](references/formatting-and-spelling.md) — Proper nouns, spell checking
- [GitHub Actions Workflow Config](../github-actions-workflow-config/SKILL.md) — CI/CD integration
- [CI CD Troubleshooting Categories](../ci-cd-troubleshooting/references/diagnostic-workflow.md) —
  Debugging Markdown lint failures
- [Testing Core Patterns](../testing/SKILL.md) — Data-driven tests for validation
