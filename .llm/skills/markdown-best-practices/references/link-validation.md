...
- [Markdown Best Practices Code Blocks](code-blocks.md) — Code block best practices
...
✅ HUMAN-READABLE
See [Core Testing Patterns](../.llm/skills/testing/SKILL.md).
```
