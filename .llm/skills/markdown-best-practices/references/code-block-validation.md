...
- [Markdown Best Practices Code Blocks](code-blocks.md) — Core fence language selection
- [Markdown Best Practices Linting](../SKILL.md) — markdownlint + CI validation rules
...
- [Markdown Best Practices Code Blocks](code-blocks.md)
- [Markdown Best Practices Linting](../SKILL.md)
