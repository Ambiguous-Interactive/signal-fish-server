# Skill: Review Changelog Entries

<!--
  trigger: changelog review, review changelog, release notes review, changelog qa
  | Review CHANGELOG.md entries for correctness, quality, and compliance
  | Core
-->

**Trigger**: After editing `CHANGELOG.md` and before finalizing work.
