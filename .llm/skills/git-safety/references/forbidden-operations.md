...
- [Git Safety Safe Operations](../SKILL.md) — What you CAN do and how to provide commit instructions
- [Agentic Workflow Patterns](../../agentic-workflow-patterns/SKILL.md) — Agent workflow that integrates with user commits
- [Mandatory Workflow](../../mandatory-workflow/SKILL.md) — User's mandatory workflow requirements
