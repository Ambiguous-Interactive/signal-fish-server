...
name: git-safety
description: >-
  Perform safe Git inspection and repository operations while avoiding destructive or
  unauthorized changes. Use when reviewing status or history, preparing commits, resolving Git
  workflow questions, or evaluating a risky Git command.
---
...
- See [Git Safety Forbidden Operations](references/forbidden-operations.md) for what is strictly forbidden
...
- [Git Safety Forbidden Operations](references/forbidden-operations.md) — What is absolutely forbidden and why
- [Agentic Workflow Patterns](../agentic-workflow-patterns/SKILL.md) — Agent workflow that integrates with user commits
- [Agent Self Review Checklist](../agent-self-review-checklist/SKILL.md) — Pre-commit verification (user commits after)
- [GitHub Actions Workflow Config](../github-actions-workflow-config/SKILL.md) — CI/CD patterns
