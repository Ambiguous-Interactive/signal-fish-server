...
description: >-
  Apply project guidance for solid principles enforcement. Use when designing, reviewing, or
  refactoring code to ensure adherence to SOLID principles and clean architecture.
---
...
- [Code Review Checklist](../code-review-checklist/SKILL.md) — Review process incorporating SOLID checks
- [Rust Refactoring Guide](../rust-refactoring-guide/SKILL.md) — Refactoring workflow for fixing violations
- [Rust Idioms And Patterns](../rust-idioms-and-patterns/SKILL.md) — Idiomatic Rust patterns
- [API Design Guidelines](../api-design-guidelines/SKILL.md) — API design following SOLID
- [Agentic Workflow Patterns](../agentic-workflow-patterns/SKILL.md) — AI agent workflow patterns for code review
