---
name: rust-idioms-and-patterns
description: >-
  Apply project guidance for Rust idioms and patterns. Use when writing new Rust code or
  reviewing code for idiomatic style and patterns.
---
...
- Performance-specific optimizations (see [Rust Performance Optimization](../rust-performance-optimization/SKILL.md))
...
Sealed traits prevent external trait implementations — see
[API Design Guidelines](../api-design-guidelines/SKILL.md).
...
See [Defensive Programming](../defensive-programming/SKILL.md) for exhaustive
matching patterns.
...
- [API Design Guidelines](../api-design-guidelines/SKILL.md) — Public API design patterns
- [Defensive Programming](../defensive-programming/SKILL.md) — Safety-first coding patterns
- [Error Handling Guide](../error-handling-guide/SKILL.md) — Error type conventions
- [Rust Refactoring Guide](../rust-refactoring-guide/SKILL.md) — Modernizing code to idiomatic patterns
