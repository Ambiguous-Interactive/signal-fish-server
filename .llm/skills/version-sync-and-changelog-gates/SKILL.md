---
name: version-sync-and-changelog-gates
description: >-
  Apply project guidance for version sync and changelog gates. Use when changing public
  behavior, docs/examples, or release-related files.
---
