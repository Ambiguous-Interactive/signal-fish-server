# Skill: Testing CI and Coverage Patterns

<!--
  trigger: ci test, smoke test, config validation test, markdown test, ci coverage, ci integration test
  | CI/CD smoke tests, config validation tests, and markdown quality tests
  | Core
-->

**Trigger**: When writing tests for CI configuration, smoke tests, or markdown/link validation.
