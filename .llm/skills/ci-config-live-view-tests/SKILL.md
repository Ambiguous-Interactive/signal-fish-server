---
name: ci-config-live-view-tests
description: >-
  Test the effective, comment-stripped view of configuration files without hiding source drift.
  Use when adding or reviewing Rust guards for comment-bearing CI or tool configuration.
---

# CI Config Live View Tests
...
- [CI Configuration Validation Tests](../github-actions-config-tests/SKILL.md) — Main pattern for config drift guards
- [GitHub Actions Workflow Config](../github-actions-workflow-config/SKILL.md) — Workflow authoring rules
