---
name: clippy-and-linting
description: >-
  Apply project guidance for clippy and linting. Use when configuring lints, resolving clippy
  warnings, or setting up CI lint enforcement.
---
...
- Writing code patterns (see [Rust Idioms And Patterns](../rust-idioms-and-patterns/SKILL.md))
- Understanding error handling (see [Error Handling Guide](../error-handling-guide/SKILL.md))
...
See [Rust Refactoring Guide](../rust-refactoring-guide/SKILL.md) for the full `cargo clippy --fix` workflow.
...
- [Rust Idioms And Patterns](../rust-idioms-and-patterns/SKILL.md) — Code patterns that satisfy lints
- [Defensive Programming](../defensive-programming/SKILL.md) — Patterns enforced by restriction lints
- [Rust Refactoring Guide](../rust-refactoring-guide/SKILL.md) — Using `cargo clippy --fix` for automated fixes
- [Testing Core Patterns](../testing/SKILL.md) — CI pipeline integration
