...
description: >-
  Apply project guidance for api design guidelines. Use when designing or modifying any public
  API surface, protocol types, HTTP endpoints, or SDK interfaces.
---
...
- Pure performance optimization (see [Rust Performance Optimization](../rust-performance-optimization/SKILL.md))
- Error type design specifically (see [Error Handling Guide](../error-handling-guide/SKILL.md))
...
See [Rust Idioms and Patterns](../rust-idioms-and-patterns/SKILL.md) for the full common traits derive checklist
...
See [Rust Idioms and Patterns](../rust-idioms-and-patterns/SKILL.md) for newtypes and enums-over-booleans patterns.
...
See [WebSocket Protocol Patterns](../websocket-protocol-patterns/SKILL.md) for full message design.

Use the typestate pattern to prevent invalid operations.
See [Rust Idioms And Patterns](../rust-idioms-and-patterns/SKILL.md) for the full typestate pattern.
...
- [Rust Idioms And Patterns](../rust-idioms-and-patterns/SKILL.md) — Rust naming conventions and canonical patterns
- [Error Handling Guide](../error-handling-guide/SKILL.md) — Designing error types for APIs
- [Defensive Programming](../defensive-programming/SKILL.md) — Input validation at API boundaries
- [WebSocket Protocol Patterns](../websocket-protocol-patterns/SKILL.md) — WebSocket-specific API patterns
