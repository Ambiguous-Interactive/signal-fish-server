---
name: github-actions-release-publication-safety
description: >-
  Apply project guidance for GitHub Actions release publication safety. Use when publishing a
  crate, recovering a partial release, resolving an existing release tag, or inspecting registry
  state before publication.
---

# GitHub Actions Release Publication Safety
...
- [GitHub Actions Release Gating](../github-actions-release/SKILL.md)
- [CI Configuration Validation Tests](../github-actions-config-tests/SKILL.md)
- [Repository Source Hygiene Guards](../repo-source-hygiene-guards/SKILL.md)
