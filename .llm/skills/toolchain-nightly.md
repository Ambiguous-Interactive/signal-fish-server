# Skill: Nightly Rust Toolchain for CI Tools

<!--
  trigger: nightly, cargo-udeps, cargo-miri, nightly toolchain, pinned nightly, toolchain date
  | Using and updating pinned nightly Rust for CI-only analysis tools
  | Infrastructure
-->

**Trigger**: When updating nightly toolchain pins, debugging nightly incompatibility with
