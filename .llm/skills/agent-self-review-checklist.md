...
⛔ **CRITICAL**: You NEVER commit changes - see [git-safety-protocol](./git-safety-forbidden-operations.md)
...
See [git-safety-protocol](./git-safety-forbidden-operations.md) for complete details.
...
⛔ **YOU NEVER**: Stage, commit, configure git, or push. See [git-safety-protocol](./git-safety-forbidden-operations.md).
