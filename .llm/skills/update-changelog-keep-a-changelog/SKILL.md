---
name: update-changelog-keep-a-changelog
description: >-
  Add release notes in the repository's Keep a Changelog format. Use after a change is classified
  as user-visible and changelog-required.
---

# Update Changelog in Keep a Changelog Format
...
- [Classify User Visible Changes](../classify-user-visible-changes/SKILL.md) — Determine whether entry is required
- [Review Changelog Entries](../review-changelog-entries/SKILL.md) — Final quality gate
- [Documentation Standards](../documentation/SKILL.md) — Documentation completeness policy
