...
description: >-
  Apply project guidance for observability and logging. Use when adding logging, metrics,
  tracing spans, or OpenTelemetry instrumentation.
---
...
- Error type design (see [Error Handling Guide](../error-handling-guide/SKILL.md))
- Performance profiling with criterion (see [Rust Performance Optimization](../rust-performance-optimization/SKILL.md))
...
- [Error Handling Guide](../error-handling-guide/SKILL.md) — Structured error logging patterns
- [Async Rust Best Practices](../async-rust-best-practices/SKILL.md) — Tracing spans for async functions
- [Defensive Programming](../defensive-programming/SKILL.md) — Logging at system boundaries
