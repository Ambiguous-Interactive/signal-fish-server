---
name: github-actions-config-tests
description: >-
  Apply project guidance for ci configuration validation tests. Use when adding tests that
  validate CI configuration files, MSRV consistency, required workflows, or coding standards.
---
...
- Runtime test failures (see [Testing Core Patterns](../testing/SKILL.md))
- Application code (see [Rust Idioms And Patterns](../rust-idioms-and-patterns/SKILL.md))
...
guard. Use [CI Config Live View Tests](../ci-config-live-view-tests/SKILL.md) for the
...
- [GitHub Actions Caching](../github-actions-caching/SKILL.md) — Ecosystem-specific caching, action ref policy
- [GitHub Actions Scheduled Workflows](../github-actions-scheduled-workflows/SKILL.md) — Schedule guard validation
- [GitHub Actions Release](../github-actions-release/SKILL.md) — Release preflight tests
- [CI Config Live View Tests](../ci-config-live-view-tests/SKILL.md) — Presence assertions against active config only
