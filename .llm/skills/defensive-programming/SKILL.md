...
description: >-
  Apply project guidance for defensive programming. Use when handling external input, fallible
  operations, or any code that could panic at runtime.
---
...
See [Rust Idioms and Patterns](../rust-idioms-and-patterns/SKILL.md) for the newtype pattern and enums-over-booleans.
...
- [Error Handling Guide](../error-handling-guide/SKILL.md) — Error type design and propagation
- [Rust Idioms And Patterns](../rust-idioms-and-patterns/SKILL.md) — Newtype and typestate patterns
- [API Design Guidelines](../api-design-guidelines/SKILL.md) — Input validation at API boundaries
- [Clippy And Linting](../clippy-and-linting/SKILL.md) — Restriction lints that enforce safety
