# Skill: Markdown Code Block Validation Patterns

<!--
  trigger: markdown, bash code blocks, mixed-content blocks, fence validation, markdown code block errors
  | Validation-focused patterns for bash fenced blocks and mixed-language examples in Markdown
  | Documentation
-->

**Trigger**: When fixing markdown code-block validation failures where content and fence language do not match.
