# Skill: Toolchain Nightly Example - Update Script

<!--
  trigger: nightly update script example, toolchain nightly update example
  | Example script for updating pinned nightly versions in workflow files
  | Infrastructure
-->

**Trigger**: When updating a pinned nightly toolchain version and validating all occurrences in workflow files.
...
- [GitHub Actions Workflow Config](./github-actions-workflow-config.md) — Workflow editing patterns
