...
name: documentation
description: >-
  Write and maintain accurate project documentation, changelogs, API docs, examples, and drift
  guards. Use when documentation changes, public behavior needs explanation, or docs must be
  kept synchronized with code and protocol behavior.
---

# Documentation Standards

Read [Accuracy and Drift](references/accuracy-and-drift.md) when documentation describes protocol
behavior, configuration, generated examples, or another source of truth that can change separately.
...
- Writing test documentation (see [Testing Core Patterns](../testing/SKILL.md))
- Formatting/linting docs (see [Mandatory Workflow](../mandatory-workflow/SKILL.md))
...
- Use [Classify User Visible Changes](../classify-user-visible-changes/SKILL.md) before writing entries
- Use [Update Changelog Keep A Changelog](../update-changelog-keep-a-changelog/SKILL.md) to author entries
- Use [Review Changelog Entries](../review-changelog-entries/SKILL.md) as final changelog QA gate
...
- [ ] User-visible scope classified (see [Classify User Visible Changes](../classify-user-visible-changes/SKILL.md))
- [ ] CHANGELOG entry added under `[Unreleased]` using Keep a Changelog sections
- [ ] CHANGELOG entry reviewed (see [Review Changelog Entries](../review-changelog-entries/SKILL.md))
