...
description: >-
  Apply project guidance for error handling guide. Use when designing error types, converting
  `.unwrap()` to proper handling, or adding error context.
---
...
- Logging errors specifically (see [Observability And Logging](../observability-and-logging/SKILL.md))
...
See [Async Rust Best Practices](../async-rust-best-practices/SKILL.md) for structured concurrency with `JoinSet`.

---

## Error Types in Public APIs (axum Handlers)

See [API Design Guidelines](../api-design-guidelines/SKILL.md) for the full pattern.
...
See [Defensive Programming](../defensive-programming/SKILL.md) for comprehensive safe alternatives.
...
- [Defensive Programming](../defensive-programming/SKILL.md) — Panic-free patterns and safe alternatives
- [API Design Guidelines](../api-design-guidelines/SKILL.md) — Error design for public APIs
- [Async Rust Best Practices](../async-rust-best-practices/SKILL.md) — Async error propagation
- [Observability And Logging](../observability-and-logging/SKILL.md) — Structured error logging
