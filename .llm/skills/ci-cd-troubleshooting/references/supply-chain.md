# CI/CD Troubleshooting - Supply Chain & Stale Reference Patterns
...
- [CI CD Troubleshooting Linting](linting-and-documentation.md) — Clippy, typos, markdown
- [CI CD Troubleshooting Scripts](scripts-and-tests.md) — Shell scripts, Miri, test filtering
- [CI CD Troubleshooting Links](link-checking.md) — Lychee, link checking
- [CI CD Troubleshooting Categories](diagnostic-workflow.md) — Diagnostic workflow, quick reference
- [Supply Chain Audit Policy](../../supply-chain-security/SKILL.md) — Security audits and scanning
