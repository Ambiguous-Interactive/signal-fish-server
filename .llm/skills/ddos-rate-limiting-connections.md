# Skill: DDoS Prevention — Rate Limiting and Connection Management

<!--
  trigger: ddos, rate-limit, rate-limiting, throttle, connection-limit, flood, abuse, backpressure, slow-loris
  | Rate limiting, connection caps, and WebSocket-level DDoS protection
  | Core
-->

**Trigger**: When implementing rate limiting middleware, connection caps, WebSocket throttling, or frame size limits.
...
- [ddos-infrastructure-monitoring](./ddos-infrastructure-monitoring.md) — Application-layer protection, WAF, monitoring, graceful degradation
