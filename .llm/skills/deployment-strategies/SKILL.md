...
description: >-
  Apply project guidance for deployment strategies for WebSocket services. Use when configuring
  Kubernetes deployments, health checks, graceful shutdown for WebSocket connections, or setting
  up container monitoring.
---
...
- [Container Docker](../containers/SKILL.md) — Dockerfile builds, image scanning, CI/CD pipelines
- [Container Security](../containers/references/security.md) — Secrets management, security contexts
...
- [Container Docker](../containers/SKILL.md) — Dockerfile, image scanning, CI/CD pipelines
- [Container Security](../containers/references/security.md) — Secrets management, security contexts
- [Observability And Logging](../observability-and-logging/SKILL.md) — Structured logging, tracing, OpenTelemetry
- [Graceful Degradation Deployment](../graceful-degradation/SKILL.md) — Connection draining, circuit breakers
