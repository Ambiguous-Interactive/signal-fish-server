...
name: testing
description: >-
  Design comprehensive Rust tests, actionable assertions, CI coverage, property tests, fuzzing,
  benchmarks, and test tooling. Use whenever production or infrastructure behavior changes, a
  regression needs reproduction, or test quality is under review.
---

# Testing Core Patterns

Read [MSRV Error Message Example](references/example-msrv-error-message.md) when writing a
multi-source consistency assertion that must report actionable expected and observed values.
...
- Configuring testing tools or frameworks (see [Testing Tools And Frameworks](references/tools-and-frameworks.md))
- Production error handling (see [Error Handling Guide](../error-handling-guide/SKILL.md))
- Benchmark-specific setup (see [Rust Performance Optimization](../rust-performance-optimization/SKILL.md))
- CI config validation tests (see [Test Fixture Structure](../test-fixtures/SKILL.md))
...
`"  - Cargo.lock"`) not bare substrings. See [CI CD Troubleshooting Scripts](../ci-cd-troubleshooting/references/scripts-and-tests.md).
...
- [Testing Error Message Quality](references/error-message-quality.md) — Writing actionable test failure messages
- [Testing CI Coverage](references/ci-and-coverage.md) — CI/CD smoke tests and config validation
- [Testing Tools And Frameworks](references/tools-and-frameworks.md) — Testing tools and coverage measurement
- [Error Handling Guide](../error-handling-guide/SKILL.md) — Testing error conditions
- [Defensive Programming](../defensive-programming/SKILL.md) — Edge cases to test
