...
- Core test methodology and patterns (see [Testing Core Patterns](../SKILL.md))
...
- [Rust Performance Optimization](../../rust-performance-optimization/SKILL.md) — Benchmark setup with criterion
- [Async Rust Best Practices](../../async-rust-best-practices/SKILL.md) — Async test patterns
