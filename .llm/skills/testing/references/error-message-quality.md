...
- Core test patterns (see [Testing Core Patterns](../SKILL.md))
- CI/CD config validation tests (see [Testing CI Coverage](ci-and-coverage.md))
...
[Testing Error Message Example MSRV Consistency](example-msrv-error-message.md).
...
- [Testing Core Patterns](../SKILL.md) — Core test patterns (unit, async, table-driven)
- [Testing CI Coverage](ci-and-coverage.md) — CI/CD smoke tests and config validation tests
- [Test Fixture Structure](../../test-fixtures/SKILL.md) — Data-driven CI configuration tests
- [Testing Error Message Example MSRV Consistency](example-msrv-error-message.md)
