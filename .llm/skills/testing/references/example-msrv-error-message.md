# Testing Error Message Example - MSRV Consistency Assertion
...
- [Testing Error Message Quality](error-message-quality.md) — Error message design guidelines
- [MSRV Management](../../msrv-management/SKILL.md) — MSRV policy and consistency rules
- [Testing Core Patterns](../SKILL.md) — General testing patterns
