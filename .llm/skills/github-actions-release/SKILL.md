...
description: >-
  Apply project guidance for GitHub Actions release gating. Use when writing release workflows,
  preflight gates, or ensuring `--locked` consistency across all cargo commands.
---
...
- [GitHub Actions Config Tests](../github-actions-config-tests/SKILL.md) — Tests that validate release workflow correctness
- [Release Publication Safety](../github-actions-release-publication-safety/SKILL.md) — Retry identity and clean worktrees
- [GitHub Actions Scheduled Workflows](../github-actions-scheduled-workflows/SKILL.md) — Cron schedules, job guards
- [GitHub Actions Workflow Config](../github-actions-workflow-config/SKILL.md) — Path filters, permissions, concurrency
