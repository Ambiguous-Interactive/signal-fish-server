...
description: >-
  Apply project guidance for GitHub Actions caching and action versioning. Use when configuring
  caching in workflows, pinning action versions, or dealing with Docker Hub image tag formats.
---

# GitHub Actions Caching & Action Versioning
...
- Container build and deployment patterns (see [Container Docker](../containers/SKILL.md))
- Scheduled workflow patterns (see [GitHub Actions Scheduled Workflows](../github-actions-scheduled-workflows/SKILL.md))
...
- [GitHub Actions Workflow Config](../github-actions-workflow-config/SKILL.md) — Workflow structure, permissions, path filters
...
- [GitHub Actions Release](../github-actions-release/SKILL.md) — Release gating, cargo --locked, preflight hardening
- [CI CD Troubleshooting Categories](../ci-cd-troubleshooting/references/diagnostic-workflow.md) —
  Diagnosing CI failures and cache errors
