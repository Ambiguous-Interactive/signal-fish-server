---
name: async-rust-best-practices
description: >-
  Apply project guidance for async Rust best practices. Use when writing or modifying any async
  code, tokio tasks, channels, or concurrent data access.
---
...
- Pure data structure design (see [Rust Idioms And Patterns](../rust-idioms-and-patterns/SKILL.md))
...
- [Rust Performance Optimization](../rust-performance-optimization/SKILL.md) — Allocation reduction and profiling
- [Error Handling Guide](../error-handling-guide/SKILL.md) — Async error propagation patterns
- [Observability And Logging](../observability-and-logging/SKILL.md) — Tracing spans for async functions
- [WebSocket Protocol Patterns](../websocket-protocol-patterns/SKILL.md) — Async WebSocket handling
