# Skill: Web Service Security — Input Validation and Authentication

<!--
  trigger: security, auth, authentication, authorization, input-validation, WebSocket-security, cors
  | Input validation, authentication, authorization, and WebSocket security
  | Core
-->

**Trigger**: When implementing authentication, authorization, input validation, or WebSocket security for the server.
