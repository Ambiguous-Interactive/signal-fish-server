---
name: msrv-management
description: >-
  Apply project guidance for msrv management. Use when updating MSRV, adding dependencies that
  require newer Rust, or debugging MSRV consistency failures in CI.
---
...
- [Toolchain Pinning](../rust-toolchains/SKILL.md) — `rust-toolchain.toml`, MSRV testing, developer workflow
- [Toolchain Nightly](../rust-toolchains/references/nightly-toolchains.md) — Nightly Rust for CI-only analysis tools
...
- [Toolchain Pinning](../rust-toolchains/SKILL.md) — `rust-toolchain.toml`, testing, developer workflow
- [Toolchain Nightly](../rust-toolchains/references/nightly-toolchains.md) — Nightly Rust for CI-only tools
- [Dependency Management Cargo](../dependency-management/SKILL.md) — Choosing and auditing dependencies
- [Container Docker](../containers/SKILL.md) — Docker build configuration
