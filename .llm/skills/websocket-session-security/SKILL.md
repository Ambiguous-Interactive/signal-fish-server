---
name: websocket-session-security
description: >-
  Prevent WebSocket session hijacking, replay, fixation, and lifecycle failures with identity
  binding, nonce and sequence controls, token rotation, timeout, and invalidation. Use when
  changing reconnect, session, peer identity, or WebSocket authentication behavior.
---
...
- Session lifecycle and JWT token validation (see [WebSocket Session Lifecycle](references/session-lifecycle.md))
- Rate limiting and connection caps (see [DDoS Rate Limiting Connections](../ddos-protection/SKILL.md))
...
- [WebSocket Session Lifecycle](references/session-lifecycle.md) — Session creation, JWT validation, timeout management
- [Web Service Security Auth](../web-service-security/SKILL.md) — General auth patterns, input validation, TLS
- [WebSocket Protocol Patterns](../websocket-protocol-patterns/SKILL.md) — WebSocket lifecycle, message framing, heartbeat
- [DDoS Rate Limiting Connections](../ddos-protection/SKILL.md) —
