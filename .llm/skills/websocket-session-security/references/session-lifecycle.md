# WebSocket Session Lifecycle Security
...
- Anti-replay mechanisms, reconnect tokens (see [WebSocket Session Hijacking](../SKILL.md))
- Rate limiting and connection caps (see [DDoS Rate Limiting Connections](../../ddos-protection/SKILL.md))
- WebSocket framing or heartbeat (see [WebSocket Protocol Patterns](../../websocket-protocol-patterns/SKILL.md))
...
- [WebSocket Session Hijacking](../SKILL.md) —
