...
v3 plus the sticky topology and transport (`ROOM_SESSION_INCOMPATIBLE`,
issue 421). Re-issued and reconnect member lists can still contain members
that never negotiated the session's sticky pair — an incumbent reconnecting
with downgraded capabilities keeps its seat.
