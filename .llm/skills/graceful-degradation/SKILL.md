...
description: >-
  Design resilient service behavior with health checks, graceful shutdown, deployment controls,
  service levels, circuit breakers, and load shedding. Use when changing availability, failure
  recovery, Kubernetes rollout behavior, or overload handling.
---

# Graceful Degradation — Health Checks, Shutdown, and Deployment
...
- Service level degradation or circuit breakers
  (see [Graceful Degradation Service Levels](references/service-levels-and-circuit-breakers.md))
...
- WebSocket protocol design unrelated to availability
  (see [WebSocket Protocol Patterns](../websocket-protocol-patterns/SKILL.md))
...
- [Graceful Degradation Service Levels](references/service-levels-and-circuit-breakers.md) — Service levels,
...
- [Error Handling Guide](../error-handling-guide/SKILL.md) — Error types, fallible operations, context propagation
- [WebSocket Protocol Patterns](../websocket-protocol-patterns/SKILL.md) — WebSocket lifecycle, close frames, heartbeat
