...
>
> Status: IN PROGRESS. **All in-repo work through P38 is complete; P39 is in
> progress.** The M1
> server core, the M2
...
> of P8).
>
> **Open follow-ups** (tracked as issues, not phases): #250 the
> client-authentication trust boundary, #251 executable `Host + Direct` plan
> eligibility, #204 design-system
> assets, #205 broader safety work, #206 distributed-resilience research, #207
> further measured optimization, #213 additional static analyzers, and #220
...
| P39 | Atomic application room ownership and quotas (#249) | M | P23 | Maintenance | In progress (s082) |
...
### P39 — Atomic application room ownership and quotas (#249) (Size M) — IN PROGRESS
...
- [ ] Complete exact-head hosted CI and the full adversarial/reviewer loop, then
  close issue #249.

**Acceptance:** application ownership and configured quotas are authoritative,
atomic at every admission boundary, backward-compatible when auth is disabled,
...
the public-app-ID trust-boundary decision remains open in issue #250.
