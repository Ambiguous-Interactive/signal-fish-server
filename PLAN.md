...
>
> Status: ACTIVE. **All in-repo work through P40 is complete; P41 is in
> progress.** The M1
> server core, the M2
...
> client-authentication trust boundary, #204 design-system
...
| P41 | Protocol-v3 edge and specification hardening (#257) | M | P1, P3, P5, P7 | Maintenance | In progress (s084) |
...
### P41 — Protocol-v3 edge and specification hardening (#257) (Size M) — IN PROGRESS
...
- [x] Pair `epoch` and `seq` in every canonical v3 room snapshot, align sample
  ...
  projection tests.
- [ ] Complete the full local validation gauntlet, adversarial review, and
  exact-head hosted CI and reviewer loop.
